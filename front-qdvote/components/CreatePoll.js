...
export default function CreatePoll() {
  ...
  const [validMins, setValidMins] = useState(30); // default 30 seconds
  ...
  return (
    <div>
      ...
      <form onSubmit={createPoll} className={styles.forms2}>
        ...
        <button className={styles.addButton} onClick={addFormFields}>
          Add
        </button>
        <br />
        <h3 className={styles.title}>
          & enter eligible voters (separated by commas):
        </h3>
          ...
          <div>
            ...
            {index ? (
              <div>
                <button
                  className={styles.removeButton}
                  onClick={() => removeEligibleFormFields(index)}
                >
                  X
                </button>
                <br />
        ...
        <button className={styles.addButton} onClick={addEligibleFormFields}>
          Add
        </button>
        <br />
        <h3 className={styles.title}>
